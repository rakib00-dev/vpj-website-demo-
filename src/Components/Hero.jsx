...
const Hero = () => {
  return (
    <>
      <header
        className={`md:mx-auto border border-gray-400 rounded-2xl p-2 bg-gradient-to-b from-[#dddbff] via-[#ecebff] to-white w-11/12 my-6 mx-4 overflow-hidden md:my-20 pb-20 max-w-7xl items-center md:p-8`}
      >
